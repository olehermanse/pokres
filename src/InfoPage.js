  ...
  render() {
    ...
    return (
      <div style={gridStyle} >
        ...
        />
        <FlatButton label="Pokémon base stats in generation VI"
        ...
        />
        <FlatButton label="Pokémon base stats in generation VII"
        ...
        />
        <FlatButton
        href="https://raw.githubusercontent.com/olehermanse/pokres/gh-pages/LICENSE.txt" label="License/Copyright ©"
        />
      </div>
    );
  }
